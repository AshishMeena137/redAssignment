...
contract Staking {
    ...
    //calculating the reward based on the duration of the stake
    function calculateReward(address user) public view returns (uint256) {
        ...
        return (staker.totalStaked.mul(rewardRate).mul(stakingDuration).div(100))/10**18;
    }
    //Saking the tokens for the user
    ...
    //Unstaking the tokens for the user
